...
$(document).on("click", "#success", function (e) {
  ...
  $(document).on("click", "#icon", function (event) {
    swal({
      ...
      imageUrl:
        "https://image.shutterstock.com/z/stock-vector--exclamation-mark-exclamation-mark-hazard-warning-symbol-flat-design-style-vector-eps-444778462.jpg",
      imageWidth: 200,
      imageHeight: 200,
  ...
  $(document).on("click", "#image", function (event) {
    swal({
      ...
      padding: 150,
      background:
        "#fff url(https://image.shutterstock.com/z/stock-vector--exclamation-mark-exclamation-mark-hazard-warning-symbol-flat-design-style-vector-eps-444778462.jpg)"
    });
  });
